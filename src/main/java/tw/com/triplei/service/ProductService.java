					...
					for (int i = 2; i <= sheet.getLastRowNum(); i++) {
						...
						for (int j = 2; j <= sheet1.getLastRowNum(); j++) {
							...
							if (rowj.getCell(0).getStringCellValue().equals(productEntity.getInsurer().getShortName())
									...
									&& rowj.getCell(6).getStringCellValue()
								...
								// 設定費率
								productPremiumRatio
										.setPremiumRatio(BigDecimal.valueOf(rowj.getCell(9).getNumericCellValue()));
						...
						for (int k = 2; k <= sheet2.getLastRowNum(); k++) {
							...
							if (rowk.getCell(0).getStringCellValue().equals(productEntity.getInsurer().getShortName())
								...
								// 第100年違約金費率
								productCancelRatio.setCancelRatio_100(
										BigDecimal.valueOf(rowk.getCell(109).getNumericCellValue()));
								// 第101年違約金費率
								productCancelRatio.setCancelRatio_101(
										BigDecimal.valueOf(rowk.getCell(110).getNumericCellValue()));
								// 第102年違約金費率
								productCancelRatio.setCancelRatio_102(
										BigDecimal.valueOf(rowk.getCell(111).getNumericCellValue()));
								// 第103年違約金費率
								productCancelRatio.setCancelRatio_103(
										BigDecimal.valueOf(rowk.getCell(112).getNumericCellValue()));
								// 第104年違約金費率
								productCancelRatio.setCancelRatio_104(
										BigDecimal.valueOf(rowk.getCell(113).getNumericCellValue()));
								// 第105年違約金費率
								productCancelRatio.setCancelRatio_105(
										BigDecimal.valueOf(rowk.getCell(114).getNumericCellValue()));
								// 第106年違約金費率
								productCancelRatio.setCancelRatio_106(
										BigDecimal.valueOf(rowk.getCell(115).getNumericCellValue()));
								// 第107年違約金費率
								productCancelRatio.setCancelRatio_107(
										BigDecimal.valueOf(rowk.getCell(116).getNumericCellValue()));
								// 第108年違約金費率
								productCancelRatio.setCancelRatio_108(
										BigDecimal.valueOf(rowk.getCell(117).getNumericCellValue()));
								// 第109年違約金費率
								productCancelRatio.setCancelRatio_109(
										BigDecimal.valueOf(rowk.getCell(118).getNumericCellValue()));
								// 第110年違約金費率
								productCancelRatio.setCancelRatio_110(
										BigDecimal.valueOf(rowk.getCell(119).getNumericCellValue()));
								// 第111年違約金費率
								productCancelRatio.setCancelRatio_111(
										BigDecimal.valueOf(rowk.getCell(120).getNumericCellValue()));
						...
						for (int m = 2; m <= sheet3.getLastRowNum(); m++) {
							...
							if (rowm.getCell(0).getStringCellValue().equals(productEntity.getInsurer().getShortName())
									...
									&& rowm.getCell(6).getStringCellValue()
											.equals(rowi.getCell(5).getStringCellValue())) {
								...
								// 下限
								productHighDiscountRatio
										.setMinValue(BigDecimal.valueOf(rowm.getCell(8).getNumericCellValue()));
								// 上限
