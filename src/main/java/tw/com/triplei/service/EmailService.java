...
public class EmailService {
	...
	public void sendEmail(String email, String replycontent) {
		...
		StringBuffer sBuffer = new StringBuffer("<!DOCTYPE html><html>")
				...
				.append("<body><div style=''>   <hr>(此為系統發送信件，請勿回覆)<hr />").append("親愛的xxx您好，<br /><br />")
				.append("我們已經於 xxxxxxxxxx年xxxxxxx月xxxxx日 xx午xx:xx收到您的提問內容：<br /><br />")
				.append("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx<br /><br />").append("我們的回覆如下：<br />")
				.append(replycontent).append("希望以上內容對您有所幫助，若還有任何關於保險的相關問題，歡迎再次到TRIPLE I的線上客服提問，<br />")
