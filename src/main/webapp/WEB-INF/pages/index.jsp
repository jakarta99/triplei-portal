		...
		<div class="col-xs-12 col-sm-10">
			...
			<c:forEach var="hotproduct" items="${hotproduct}">
				<div class="col-xs-12 col-sm-12" style="width: auto; height: 18vh; margin-bottom: 8vh;">
					...
					<img class="col-xs-3 col-sm-3" src="${hotproduct.insurer.imgsrc}" style="height: 100%; padding: 0;" />
						<div class="col-xs-9 col-sm-9" style="height: 100%; text-align: left; padding: 0;">
							<div style="padding: 0;">
								<div style="font-size: 190%; padding-top: 1vh;" id="asdfghjkl">${hotproduct.insurer.name}</div>
							</div>
							<div style="font-size: 130%;">
								<div class="align-middle" style="margin-top: -1vh;">${hotproduct.code} - ${hotproduct.localName}</div>
							</div>
						</div>
					</a>
				</div>
