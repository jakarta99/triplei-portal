...
<c:import url="/WEB-INF/pages/layout/navbar.jsp"></c:import>
	<div>
		<div class="col-sm-4" style="height: 100vh; display: table; table-layout: fixed; padding-right: 0px; padding-left: 0px;">
		<!-- 左邊白 -->
			...
			<div class=" col-sm-8  text-center " style="height: 100vh; background-color: #5C8DEC; padding-right: 0px; padding-left: 0px;">
				<!--右邊藍 -->
				<div class="col-sm-12"
			...
			<div class="col-sm-6" style="height: 100vh;">
				...
				<div class="col-sm-10">
					...
					<div class="col-sm-12" style="height: 80vh; display: flex; flex-direction: column;" align='center'>
						<div class="col-sm-12" style="border: 1px #5C8DEC solid; height: 18vh; width: 34vw; margin-bottom: 10vh">a</div>
						<div class="col-sm-12" style="border: 1px #5C8DEC solid; height: 18vh; width: 34vw; margin-bottom: 10vh">a</div>
						<div class="col-sm-12" style="border: 1px #5C8DEC solid; height: 18vh; width: 34vw">a</div>
					</div>
				</div>
				<div class="col-sm-1"></div>
			</div>
			<!--右半圖 -->
			<div class="col-sm-6" style="height: 100vh;">
				<div class="col-sm-12" style="height: 100%; display: flex; justify-content: flex-end; flex-direction: column" align='center'>
...
<!-- 				<div class="col-sm-10"> -->
					...
					<div class="col-sm-4" style="height: 60vh;">
					<!--三個框框 -->
						<div class="col-sm-1"></div>
