...
<script type="text/javascript"
	src="<c:url value="/resources/slick/slick.min.js"/>"></script>
...
<body>
	<div class="container-fluid"
		...
		<div style="padding: 0; width: 100%; height: 100%; color: white;">
			...
			<div class="col-lg-9"
				style="height: 100%; padding: 0; overflow-y: scroll; color: black">
				<div id="ArticleCarousel" class="col-md-12"
					style="height: 40vh; width: 100%; padding: 0;">
					<div>
						<a href="/article/readArticle/read/${bannerRotation[0].id}"><img
							src="${bannerRotation[0].bannerImage}"
							title="${bannerRotation[0].title}" class="rotation"></a>
					</div>
					<div>
						<a href="/article/readArticle/read/${bannerRotation[1].id}"><img
							src="${bannerRotation[1].bannerImage}"
							title="${bannerRotation[1].title}" class="rotation"></a>
					</div>
					<div>
						<a href="/article/readArticle/read/${bannerRotation[2].id}"><img
							src="${bannerRotation[2].bannerImage}"
							title="${bannerRotation[2].title}" class="rotation"></a>
					</div>
				</div>
				<div class="col-md-12" id="list">
					<div class="col-sm-12" id="editorChoice">
						<a href="/article/editorChoice"><h3>編輯精選</h3></a>
