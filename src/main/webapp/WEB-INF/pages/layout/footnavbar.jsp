<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<div class="col-xs-12 col-sm-12" style="height: 18vh;background-color: #030033;margin: 0px;color: white;padding-left: 0px;padding-right: 0px">
...
<div class="col-xs-9 col-sm-7" style="padding-top: 5vh;font-family: 微軟正黑體;padding-right: 0px">
