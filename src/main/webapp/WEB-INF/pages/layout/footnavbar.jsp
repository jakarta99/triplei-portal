<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<div class="col-sm-12" style="height: 18vh;background-color: #030033;margin: 0px;color: white;">
...
<div class="col-xs-9 col-sm-7" style="padding-top: 5vh;font-family: 微軟正黑體;">
