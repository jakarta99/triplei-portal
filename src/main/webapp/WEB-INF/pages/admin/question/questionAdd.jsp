						...
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								...
								<div class="form-group required">
			    					<label for="code" class="col-md-2 control-label">問題分類1</label>
			    					<div class="col-md-10">
			      						<input type="text" class="form-control" id="questionType" name="questionType" placeholder="questionType" value=""/>
								...
								<div class="form-group required">								  					
			    					...
			    					<div class="col-md-10">
			      						<input type="text" class="form-control" id="questionType2" name="questionType2" placeholder="questionType2" value=""/>
			      						<span class="help-block"><div class="text-danger"></div></span>
			    					</div>
								</div>
								
			  					<div class="form-group required">
			    					<label for="shortName" class="col-md-2 control-label">Email</label>
			    					<div class="col-md-10">
			      						<input type="text" class="form-control" id="askerEmail" name="askerEmail" placeholder="askerEmail" value=""/>
			      						<span class="help-block"><div class="text-danger"></div></span>
			    					</div>
								</div>
								
								<div class="form-group required">
			    					<label for="sortNo" class="col-md-2 control-label">問題內容</label>
			    					<div class="col-md-10">
								...
								<div class="form-group required">
			    					<label for="sortNo" class="col-md-2 control-label">提問時間</label>
			    					<div class="col-md-10">
