					...
					<input type="hidden" id="id" name="id" value="${entity.id}"/>
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h4><span class="glyphicon glyphicon-edit"></span>&nbsp; <strong>問題修改</strong></h4>
							</div>
							<div class="panel-body">
								...
								<div class="form-group required">								  					
			  					...
			  					<div class="form-group required">
			    					...
			    					<div class="col-md-10">
			      						<input type="text" class="form-control" id="questionType2" name="questionType2" placeholder="questionType2" value="${entity.questionType2}"/>
			      						<span class="help-block"><div class="text-danger"></div></span>
			    					</div>
								</div>	
								...
								<div class="form-group required">								  					
			    					...
			    					<div class="col-md-10">
			      						<input type="text" class="form-control" id="postTime" name="postTime" placeholder="postTime" value="${entity.postTime}"/>
			      						<span class="help-block"><div class="text-danger"></div></span>
			    					</div>
								</div>
